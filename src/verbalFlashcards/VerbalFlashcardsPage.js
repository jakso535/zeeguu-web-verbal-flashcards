...
export default function VerbalFlashcardsPage() {
    ...
    }, [api, selectedCategory, selectedDifficulty]);
                ...
                try {
                    ...
                    if (maxSample > threshold) {
                        ...
                        if (speechDuration >= 150) {
                            ...
                            updateStatusWithDebounce('⏸️ Silence detected, stopping...', 'processing', 100);
                        } else {
                            speechActive = false;
                        }
                    }
            ...
            <s.HeaderSection>
                <s.TitleSection>
                    ...
                    <s.FiltersContainer>
                        ...
                        <s.FilterButton onClick={applyFilters}>Apply Filters</s.FilterButton>
                ...
                <s.CardContent>
                    {loading ? (
                        ...
                        <>
                            {/* Prompt section */}
                            <s.PromptSection>
                                <s.Badge difficulty={currentCard.difficulty}>
