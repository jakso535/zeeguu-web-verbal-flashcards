...
export const SoundWave = styled.div`
   ...
   span:nth-child(2) { animation-delay: 0.1s; height: 30px; }
   span:nth-child(3) { animation-delay: 0.2s; height: 40px; }
   span:nth-child(4) { animation-delay: 0.3s; height: 30px; }
   span:nth-child(5) { animation-delay: 0.4s; height: 20px; }
